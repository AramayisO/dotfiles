...
vim.keymap.set("n", "<leader>gd", telescope_builtins.lsp_definitions, { noremap = true, silent = true, desc = "goto definitions" })
vim.keymap.set("n", "<leader>gr", telescope_builtins.lsp_references, { noremap = true, silent = true, desc = "goto references" })
vim.keymap.set("n", "<leader>gi", telescope_builtins.lsp_implementations, { noremap = true, silent = true, desc = "goto implementations" })
